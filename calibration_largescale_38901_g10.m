...
% today = '2020-07-20';
if ~exist(['.\results\TR38901\large_scale_result','_',today],'file') 
    mkdir(['.\results\TR38901\large_scale_result','_',today]);
end 
...
%             end
        ...
        fname = ['.\results\TR38901\large_scale_result','_',today,'\',scenario.name,'_',num2str(frequency/1e9),'GHz.mat'];
        save(fname,'result');
    end
end
