...
%
%   This function implements a 2D linear interpolation which is highly optimized for fast execution. 
%   All calculations are done in single-precision floating point (30% faster than double
