function [ Re, De, Re_dual ] = acf_estimate( objsos, no_pos, D )
...
%   sos.val. The distance between each pair of positions is calculated and pairs with similar
...
%
%   De
%   Distance vector containing the actual center distances in [m] of the groups calculated from the random positions.
%
%   Re_dual
