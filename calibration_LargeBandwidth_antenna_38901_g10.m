...
% today = '2020-08-06';
if ~exist(['.\results\TR38901\LargeBandwidth_result','_',today],'file') 
    mkdir(['.\results\TR38901\LargeBandwidth_result','_',today]);
end 
...
%         title('CDF of ASA');xlabel('ASA (degree)');ylabel('CDF');xlim([0, 120])
        ...
        fname = ['.\results\TR38901\LargeBandwidth_result','_',today,'\',scenario.name,'_',num2str(frequency/1e9),'GHz.mat'];
        save(fname,'result');
    end
end
